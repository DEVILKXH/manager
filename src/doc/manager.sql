...
CREATE TABLE `sys_login_log` (
  ...
  `LASTEST_LOGIN_TIME` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '最近登录时间',
  `LASTEST_LOGOUT_TIME` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '最近登出时间',
